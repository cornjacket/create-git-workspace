...
| 20 | `sources` should be a verb, not a manual seam — [`20`](docs/plans/dogfood/20-sources-should-be-a-verb.md) | **reader done 08-07** — `routine-sync.py --check`, 394 assertions, live; the writer stays open behind a round-trip verification |
